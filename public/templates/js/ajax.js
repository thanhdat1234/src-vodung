...
function cms_func_common() {
  ...
  if (window.location.pathname.indexOf("input") !== -1) {
    ...
    $(".customer-pay").keyup(function () {
      var customer_pay;
      if ($("input.customer-pay").val() == "") customer_pay = 0;
      else
        customer_pay = cms_decode_currency_format(
          $("input.customer-pay").val()
        );

      var total_after_discount = cms_decode_currency_format(
...
function cms_cruser() {
  ...
  $("#frm-cruser .group-user .group-selbox #sel-group").on(
    "change",
    function () {
      $group = $(this).val();
    }
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data != "1") {
          ...
          cms_upuser();
          $(".ajax-success-ct")
            .html("Thêm thành viên mới thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data != "0") {
        ...
        var $html =
          '<tr><td colspan="7" class="text-center">Không có người dùng để hiển thị</td> </tr>';
...
function cms_save_item_user(id) {
  var $display_name = $(
    "#user .table-user tr.edit-tr-item-" + id + " td.itdisplay_name input"
  ).val();
  var $mail = $(
    "#user .table-user tr.edit-tr-item-" + id + " td.itemail input"
  ).val();
  var $group = $(
    "#user .table-user tr.edit-tr-item-" + id + " td.itgroup_name #sel-group"
  ).val();
  var $status = $(
    "#user .table-user tr.edit-tr-item-" +
      id +
      " td.ituser_status .ituser_status"
  ).val();
  var $data = {
    data: {
      id: id,
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data != "0") {
          cms_upuser();
          $(".ajax-success-ct")
            .html("Xóa thành viên thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data == "1") {
        ...
        $(".ajax-error-ct")
          .html("Thực hiện không thành công!")
          .parent()
          .fadeIn()
          .delay(1000)
          .fadeOut("slow");
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data != "0") {
        ...
        var $html =
          '<tr><td colspan="3" class="text-center">Không có chức năng để hiển thị</td> </tr>';
    ...
    if ($group_name) {
      var $param = {
        ...
        callback: function (data) {
          if (data != "1") {
            $(".ajax-error-ct")
              .html("Nhóm người dùng đã tồn tại hoặc không đúng!")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
            ...
            cms_radiogroup();
            $(".ajax-success-ct")
              .html("Bạn đã tạo mới Nhóm người dùng thành công!")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
  ...
  if ($store_name) {
    var $param = {
      ...
      callback: function (data) {
        if (data != "1") {
          $(".ajax-error-ct")
            .html("Tên kho đã tồn tại hoặc không đúng!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Bạn đã tạo kho thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (total_money.length == 0 || total_money == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data != "1") {
          $(".ajax-error-ct")
            .html("Tạo phiếu thu không thành công. Vui lòng thử lại!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".btn-close").trigger("click");
          $(".ajax-success-ct")
            .html("Bạn đã tạo phiếu thu thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data != "0") {
        ...
        var $html =
          '<tr><td colspan="3" class="text-center">Không có Group để hiển thị</td> </tr>';
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data != "0") {
        ...
        var $html =
          '<tr><td colspan="3" class="text-center">Không có kho để hiển thị</td> </tr>';
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data != "0") {
        ...
        var $html =
          ' <button style="color: green; font-size: 16px;" class="btn btn-default btn-sm create-group" data-toggle="modal" data-target="#create-group"><i class="fa fa-plus"></i></button>';
...
function cms_savefunc() {
  ...
  if (!$group_id) {
    $(".ajax-error-ct")
      .html("Vui lòng chọn nhóm người sử dụng trước khi thực hiện lưu quyền!")
      .parent()
      .fadeIn()
      .delay(1000)
      .fadeOut("slow");
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data == "1") {
        $(".ajax-success-ct")
          .html("Lưu chức năng cho nhóm thành công.")
          .parent()
          .fadeIn()
          .delay(1000)
          .fadeOut("slow");
        ...
        $(".ajax-error-ct")
          .html("Thực hiện không thành công do Nhóm không tồn tại!")
          .parent()
          .fadeIn()
          .delay(1000)
          .fadeOut("slow");
        ...
        $(".ajax-error-ct")
          .html("Lỗi hệ thống vui lòng liên hệ nhà cung cấp phần mềm!")
          .parent()
          .fadeIn()
          .delay(1000)
          .fadeOut("slow");
...
function cms_save_item_group($id) {
  "use strict";
  var $group_name = $(
    ".table-group tr.edit-tr-item-" + $id + " td.itgr_name input"
  ).val();
  if ($group_name.length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data > 0) {
          ...
          $(".ajax-error-ct").hide();
          $(".ajax-success-ct")
            .html("Bạn đã tạo mới khách hàng thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-error-ct")
            .html("Mã khách hàng đã tồn tại, Vui lòng chọn mã khác")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa Khách hàng")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Bạn đã xóa khách hàng thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if ($name.length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Bạn đã cập nhật khách hàng thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data > 0) {
          ...
          $(".ajax-error-ct").hide();
          $(".ajax-success-ct")
            .html("Bạn đã tạo mới nhà cung cấp thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa nhà cung cấp này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Bạn đã xóa nhà cung cấp thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if ($name.length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Bạn đã cập nhật nhà cung cấp thành công!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          $(".ajax-success-ct")
            .html("Tạo nhà sản xuất thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          $("#prd_manuf_name").val("");
          if ($cont == 1) $(".btn-close").trigger("click");
        } else {
          $(".ajax-error-ct")
            .html(
              "Tên Nhà sản xuất đã có trong hệ thống. Vui lòng chọn tên khác."
            )
            .parent()
            .fadeIn()
            .delay(1000)
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          cms_load_listunit();
          $(".ajax-success-ct")
            .html("Tạo đơn vị tính thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-error-ct")
            .html(
              "Tên đơn vị tính đã có trong hệ thống. Vui lòng chọn tên khác."
            )
            .parent()
            .fadeIn()
            .delay(1000)
    ...
    $(wrapper).append(
      `<div class="form-group clearfix">
            ...
            <div class="col-md-4 padd-right-0">
                ...
                <button type="button" onclick=cms_remove_input(); class="btn btn-danger remove_field" style="border-radius: 3px; box-shadow: none;color:black">X
                </button>
            </div>`
    );
  });
...
function cms_add_input_img() {
  ...
  $(document).ready(function () {
    ...
    <button type="button" onclick=cms_remove_input_img(); class="btn btn-danger remove_field_img" style="border-radius: 3px; box-shadow: none;color:black">X
    </button>
    </div>
    `  
    );
...
function cms_remove_input_img() {
  "user strict";
  var wrapper = $(".input_image_wrap"); //Fields wrapper
  $(document).ready(function () {
    $(wrapper).on("click", ".remove_field_img", function (e) {
...
function cms_remove_input($id = 0) {
  "user strict";
  if ($id) {
    var $param = {
      type: "POST",
      url: "product/cms_delete_config/" + $id,
      data: null,
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa cấu hình sản phẩm này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_create_config($cont) {
  "user strict";

  var $prd_config_name = $.trim($("#prd_config_name").val());
  var $prd_config_value = $.trim($("#prd_config_value").val());
  if ($prd_config_name.length == 0 || $prd_config_value.length == 0) {
    alert("Nhập tên và giá trị cấu hình.");
  } else {
    var $param = {
      type: "POST",
      url: "product/cms_create_config",
      data: {
        data: {
          prd_config_name: $prd_config_name,
          prd_config_value: $prd_config_value,
        },
      },
      callback: function (data) {
        if (data == "1") {
          ...
          $(".ajax-error-ct")
            .html("Tên cấu hình đã có trong hệ thống. Vui lòng chọn tên khác.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_paging_config($page) {
  var $param = {
    type: "POST",
    url: "product/cms_paging_config/" + $page,
    data: null,
    callback: function (data) {
      $(".prd_config-body").html(data);
    },
  };
  cms_adapter_ajax($param);
}
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa Nhà sản xuất sản phẩm này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Xóa nhà sản xuất thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa đơn vị tính sản phẩm này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Xóa đơn vị tính thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_delete_config($id, $page) {
  var conf = confirm("Bạn chắc chắn muốn xóa cấu hình sản phẩm này!");
  if (conf) {
    var $param = {
      type: "POST",
      url: "product/cms_delete_config/" + $id,
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa phiếu thu này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Lỗi! không thể xóa phiếu chi này")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          cms_load_listgroup();
          $(".ajax-success-ct")
            .html("Cập nhật Nhà sản xuất sản phẩm thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          cms_load_listunit();
          $(".ajax-success-ct")
            .html("Cập nhật đơn vị tính sản phẩm thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_update_prdconfig($id) {
  "use strict";
  var $prd_config_name = $.trim($(".edit_prd_config_name-" + $id).val());
  var $prd_config_value = $.trim($(".edit_prd_config_value-" + $id).val());
  if ($prd_config_name.length == 0 || prd_config_value.length == 0) {
    alert("Nhập tên và giá tri cấu hình sản phẩm.");
  } else {
    var $param = {
      type: "POST",
      url: "product/cms_update_prdconfig/" + $id,
      data: {
        data: {
          prd_config_name: $prd_config_name,
          prd_config_value: $prd_config_value,
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          cms_load_listconfig();
          $(".ajax-success-ct")
            .html("Cập nhật cấu hình sản phẩm thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_create_group($cont) {
  ...
  var $data = {
    data: { prd_group_name: $prd_group_name, parentid: $parentid },
  };
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          $(".ajax-error-ct")
            .html(
              "Tên danh mục cùng cấp đã tồn tại trong hệ thống. Vui lòng chọn tên khác."
            )
            .parent()
            .fadeIn()
            .delay(1000)
          ...
          $(".ajax-error-ct")
            .html("Opps! Something went wrong. please try again!")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_load_listconfig() {
  var $param = {
    type: "POST",
    url: "product/cms_load_listconfig",
    data: null,
    callback: function (data) {
      $("#prd_config_id").html(data);
      cms_product_config_show();
    },
  };
  cms_adapter_ajax($param);
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          cms_load_listgroup();
          $(".ajax-success-ct")
            .html("Cập nhật danh mục thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-error-ct")
            .html("Tên danh mục đã có trong hệ thống. Vui lòng chọn tên khác.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          $(".ajax-error-ct")
            .html("Oops! This system is errors! please try again.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          if (
            confirm(
              "Danh mục này đã có chứa sản phẩm, Bạn có chắc chắn muốn xóa?"
            )
          ) {
            var $param = {
              type: "POST",
...
function cms_get_config_data(className) {
  var arr = [];
...
function cms_add_product(type) {
  ...
  var $configName = cms_get_config_data("configName");
  var $configValue = cms_get_config_data("configValue");
  var $linkImg = cms_get_config_data("linkImg");
  ...
  var $config_id = $("#prd_config_id").val();
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          if (type == "save") {
            $(".ajax-success-ct")
              .html("Tạo sản phẩm " + $name + " thành công.")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
...
function cms_update_product($id) {
  ...
  var $configValue = cms_get_config_data("configValue");
  var $linkImg = cms_get_config_data("linkImg");
  var $configId = cms_get_config_data("configId");
  var $allownegative = cms_get_valCheckbox("prd_allownegative", "id");
  var $prd_image_url = $("#img_preview").text();
  var $origin_price = cms_decode_currency_format($("#prd_origin_price").val());
  var $sell_price = cms_decode_currency_format($("#prd_sell_price").val());
  ...
  if ($name.length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Cập nhật sản phẩm " + $name + " thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Xác nhận nhập kho thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if (conf) {
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Khôi phục sản phẩm thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_deactivate_product($id, $page) {
  var conf = confirm(
    "Bạn có thực sự muốn ngừng kinh doanh sản phẩm này không?"
  );
  if (conf) {
    var $param = {
      type: "POST",
      ...
      callback: function (data) {
        if (data == "1") {
          $(".ajax-success-ct")
            .html("Ngừng kinh doanh sản phẩm thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          if (link.indexOf("orders") !== -1) {
            if ($("#search-option-1").val() >= 0) cms_paging_order(1);
          } else if (link.indexOf("product") !== -1) {
            if ($("#search-option-1").val() >= 0) cms_paging_order(1);
          } else if (link.indexOf("inventory") !== -1) {
            if ($("#option_inventory").val() >= 0) cms_paging_inventory(1);
...
function cms_product_group_show() {
  $("#prd_group_id").change(function () {
    //jQuery Change Function
    var opval = $(this).val(); //Get value from select element
    if (opval == "product_group") {
...
function cms_product_manufacture_show() {
  $("#prd_manufacture_id").change(function () {
    //jQuery Change Function
    var opval = $(this).val(); //Get value from select element
    if (opval == "product_manufacture") {
      //Compare it and if true
...
function cms_product_unit_show() {
  $("#prd_unit_id").change(function () {
    //jQuery Change Function
    var opval = $(this).val(); //Get value from select element
    if (opval == "product_unit") {
      //Compare it and if true
      $("#list-prd-unit").modal("show"); //Open Modal
    }
  });
}
function cms_product_config_show() {
  $("#prd_config_id").change(function () {
    //jQuery Change Function
    var opval = $(this).val(); //Get value from select element
    if (opval == "product_config") {
      //Compare it and if true
      $("#list-prd-config").modal("show"); //Open Modal
    }
  });
}
...
function cms_save_orders(type) {
  if ($("tbody#pro_search_append tr").length == 0) {
    $(".ajax-error-ct")
      .html(
        "Xin vui lòng chọn ít nhất 1 sản phẩm cần xuất trước khi lưu đơn hàng. Xin cảm ơn!"
      )
      .parent()
      .fadeIn()
      .delay(1000)
    ...
    $customer_id =
      typeof $("#search-box-cys").attr("data-id") === "undefined"
        ? 0
        : $("#search-box-cys").attr("data-id");
    ...
    $("tbody#pro_search_append  tr").each(function () {
      ...
      $price = cms_decode_currency_format(
        $(this).find("input.price-order").val()
      );
      $detail.push({
        id: $id,
        quantity: $quantity,
    ...
    var $param = {
      ...
      callback: function (data) {
        if (isNaN(parseInt(data))) {
          ...
          $(".ajax-error-ct")
            .html("Vui lòng chọn khách hàng để có thể bán nợ")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          if (type == 1) {
            $(".ajax-success-ct")
              .html("Đã lưu thành công đơn hàng.")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
            ...
            $(".ajax-success-ct")
              .html("Đã khởi tạo thành công đơn hàng.")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
...
function cms_save_input_return($type, $input_id) {
  if ($("tbody#pro_search_append tr").length == 0) {
    $(".ajax-error-ct")
      .html(
        "Xin vui lòng chọn ít nhất 1 sản phẩm cần xuất trước khi lưu đơn hàng xuất trả. Xin cảm ơn!"
      )
      .parent()
      .fadeIn()
      .delay(1000)
  ...
  if ($("tbody#pro_search_append tr").length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-success-ct")
            .html("Đã lưu thông tin thành công")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Cập nhật đơn hàng thành công")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Đơn hàng đã chuyển sang trạng thái thành công")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Đơn hàng đã chuyển sang trạng thái xác nhận")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Đơn hàng đã chuyển sang trạng thái đang giao hàng")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Đơn hàng đã chuyển sang trạng thái đã giao hàng")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
          ...
          $(".ajax-success-ct")
            .html("Đơn hàng đã chuyển sang trạng thái hủy")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function save_receipt_order($order_id) {
  if ($("#receipt_money").val() < 1) {
    $(".ajax-error-ct")
      .html("Vui lòng nhập số tiền thu")
      .parent()
      .fadeIn()
      .delay(1000)
      .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          ...
          $(".ajax-success-ct")
            .html("Đã lưu phiếu thu thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          ...
          $(".ajax-success-ct")
            .html("Đã lưu phiếu chi thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function save_receipt_order_in_customer($order_id) {
  if ($("#receipt_money-" + $order_id).val() < 1) {
    ...
    $receipt_money = cms_decode_currency_format(
      $("#receipt_money-" + $order_id).val()
    );
    $store_id = $("#store-id").val();
    $receipt_date = $("#receipt_date").val();
    $receipt_method = $("input:radio[name ='payment-method']:checked").val();
...
function save_payment_input_in_supplier($input_id) {
  if ($("#payment_money-" + $input_id).val() < 1) {
    ...
    $payment_money = cms_decode_currency_format(
      $("#payment_money-" + $input_id).val()
    );
    $store_id = $("#store-id").val();
    $payment_date = $("#payment_date").val();
    $payment_method = $("input:radio[name ='payment-method']:checked").val();
  ...
  if ($("tbody#pro_search_append tr").length == 0) {
    ...
    if ($to_store == "") {
      ...
      $("tbody#pro_search_append  tr").each(function () {
        ...
        $detail.push({ id: $id, quantity: $value_input });
      });
      ...
      var $param = {
        ...
        callback: function (data) {
          if (data == "0") {
            ...
            if (type == 1) {
              $(".ajax-success-ct")
                .html("Đã lưu thành công phiếu chuyển kho.")
                .parent()
                .fadeIn()
                .delay(1000)
                .fadeOut("slow");
              ...
              $(".ajax-success-ct")
                .html("Đã khởi tạo thành công phiếu chuyển kho.")
                .parent()
                .fadeIn()
                .delay(1000)
                .fadeOut("slow");
...
function cms_change_status_order($id, $order_status) {
  ...
  var $param = {
    ...
    callback: function (data) {
      if (data == "1") {
        $(".ajax-success-ct")
          .html("Lưu trạng thái đơn hàng thành công.")
          .parent()
          .fadeIn()
          .delay(1000)
          .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          cms_paging_order($page);
          $(".ajax-success-ct")
            .html("Xóa đơn hàng vĩnh viễn thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          ...
          $(".ajax-success-ct")
            .html("Xóa phiếu nhập thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_save_import(type) {
  if ($("tbody#pro_search_append tr").length == 0) {
    $(".ajax-error-ct")
      .html(
        "Xin vui lòng chọn ít nhất 1 sản phẩm cần xuất trước khi lưu hóa đơn nhập. Xin cảm ơn!"
      )
      .parent()
      .fadeIn()
      .delay(1000)
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          ...
          if (type == 1) {
            $(".ajax-success-ct")
              .html("Đã lưu thành công phiếu nhập.")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
            ...
            $(".ajax-success-ct")
              .html("Đã lưu thành công phiếu nhập tạm.")
              .parent()
              .fadeIn()
              .delay(1000)
              .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          ...
          $(".ajax-success-ct")
            .html("Cập nhật phiếu nhập thành công")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
  ...
  if ($("tbody#pro_search_append tr").length == 0) {
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "0") {
          $(".ajax-error-ct")
            .html("Đơn hàng này đã trả hết hàng. Vui lòng chọn đơn hàng khác.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
    ...
    var $param = {
      ...
      callback: function (data) {
        if (data == "1") {
          cms_paging_input($page);
          $(".ajax-success-ct")
            .html("Xóa vĩnh viễn phiếu nhập thành công.")
            .parent()
            .fadeIn()
            .delay(1000)
            .fadeOut("slow");
...
function cms_paging_order($page) {
  ...
  if ($("#customer_id").val() != null) $customer_id = $("#customer_id").val();
...
function cms_load_infor_order() {
  ...
  debugger;
  if (
    $("input.discount-percent-order").val() != "" &&
    $("input.discount-percent-order").val() != 0
  ) {
  ...
  if ($("input.discount-order").val() == "") $discount = 0;
  else $discount = cms_decode_currency_format($("input.discount-order").val());
  ...
  $(".total-after-discount").text(
    cms_encode_currency_format($total_after_discount)
  );
  $("input.customer-pay").val(
    cms_encode_currency_format($total_after_discount)
  );
...
function cms_load_infor_import() {
  ...
  if ($("input.discount-import").val() == "") $discount = 0;
  else $discount = cms_decode_currency_format($("input.discount-import").val());
...
function cms_decode_currency_format(obs) {
  if (obs == "") return 0;
  else return parseInt(obs.replace(/,/g, ""));
}
