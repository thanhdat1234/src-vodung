        ...
        foreach ($data['_list_product'] as $key => $item) : ?>
            <tr>
               ...
               <td class="text-center"
                  style="width: 35px;">
                  <?php
                    if(!empty($item['prd_image_url'])){
                      $images = explode(',',$item['prd_image_url']);
                    ?>
                      <img src='public/templates/uploads/<?php echo $images[0]?>' alt='<?php echo $item['prd_name']?>' width='100px' height='100px' style='border-radius: 5px; padding: 3px; border: 1px solid #ccc;'/> 

                  <?php
                    } else{
                    ?>
                    <img src='public/templates/uploads/no-img.jpg' alt='no image' width='100px' height='100px' style='border-radius: 5px; padding: 3px; border: 1px solid #ccc;'/> 
                  <?php
                    }
                    ?>
                </td>
