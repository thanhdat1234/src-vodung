                    ...
                    <div class="row">
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-6 padd-left-0">
                                ...
                                <div class="col-md-12 padd-0">
                                    <div><?php 
                                    if(count($_detail_product['_prd_config'])){
                                        foreach($_detail_product['_prd_config'] as $key=>$value){
                                            echo $value['prd_config_name'].': '.$value['prd_config_value'].'</br>';
                                        }
                                    }else{
                                        echo "Chưa có cấu hình";
                                    }
                                    ?></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 padd-20">
                                <div class="jumbotron text-center" id="img_upload"
                                    ...
                                    <p>
                                    <?php
                                        if(isset($_detail_product) && !empty($_detail_product['prd_image_url'])){
                                            $images = explode(',',$_detail_product['prd_image_url']);
