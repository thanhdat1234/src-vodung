...
<div class="modal fade" id="list-prd-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Quản lý cấu hình</h4>
            </div>
            <div class="modal-body">
                <div class="tabtable">
                <ul class="nav nav-tabs tab-setting" role="tablist"
                        style="background-color: #EFF3F8; padding: 5px 0 0 15px;">
                        <li role="presentation" class="active list-config-click" style="margin-right: 3px;"><a
                                href="#list-config" aria-controls="list-config" role="tab"
                                data-toggle="tab"><i class="fa fa-list"></i> Danh sách cấu hình</a></li>
                        <li role="presentation"><a href="#create-config" aria-controls="create-config"
                                                   role="tab" data-toggle="tab"><i class="fa fa-plus"></i> Tạo mới cấu hình</a></li>
                    </ul>
                    <div class="tab-content" style="padding:10px; border: 1px solid #ddd; border-top: none;">
                        <div role="tabpanel" class="tab-pane active" id="list-config">
                            <div class="prd_config-body">
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="create-config">
                            <div class="row form-horizontal">
                            <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-4 text-right">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control"
                                                   id="prd_config_name" value="" placeholder="Nhập tên cấu hình">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                        <input type="text" class="form-control"
                                                   id="prd_config_value" value="" placeholder="Nhập giá trị cấu hình">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-8 col-md-offset-4">
                                            <button type="button" class="btn btn-primary"
                                                    style="border-radius: 0 3px 3px 0;" onclick="cms_create_config(1);"><i
                                                    class="fa fa-check"></i> Lưu
                                            </button>
                                            <button type="button" class="btn btn-primary "
                                                    onclick="cms_create_config(0);"><i class="fa fa-floppy-o"></i> Lưu
                                                và tiếp tục
                                            </button>
                                        </div>
                                    </div>
...
<!-- Product Options -->
<div class="modal fade" id="list-prd-options-1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
